...
acontinuacion se presenta una serie de ejercicios el cual, el alumno programara en python 
...
Para la realización de este ejercicio se hizo uso simplemente de dos multiplicaciones y una suma, en este programa se realiza el intercambio de botellas plásticas por dinero (botellas de menos de un litro equivalen a $0.10 y botellas de más de un litro equivale a $0.25), se tiene que ingresar al programa un numero de botella de menos de 1 litro y el número de botellas de más de 1 litro, al ingresar la cantidad de botellas, el programa calcula cuantas botellas se ingresan y suma los resultados dando una sola cantidad generada.https://github.com/diego-90/progAvanzada/blob/master/ejercicio5.py
...
https://github.com/diego-90/progAvanzada/blob/master/ejercicio15.py
...
Sugerencia: La capacidad calorífica específica del agua es 4.186 J g◦C. Debido a que el agua tiene una densidad de 1.0 gramo por mililitro, puede usar gramos y mililitros de manera intercambiable en este ejercicio. https://github.com/diego-90/progAvanzada/blob/master/ejercicio17.py
...
## Ejercicio 46
El año está dividido en cuatro temporadas: Primavera, verano, otoño e invierno. Aunque las fechas exactas cambian un poco dependiendo del año, usemos las siguientes fechas:
...
El usuario introducirá el nombre del mes como una 'string' seguido del dia como entero 'int'
Su programa debe desplegar la temporada de acuerdo a la información introducida por el usuario.
